...
NDX.MAP_PLAN_CH1 = [
  { type: 'mob',   name: '山道喽啰', diff: 1, gold: 22, drop: 'tm_w_base' }, // idx0 第1层(被固定序章覆盖)
  { type: 'trial', name: '劫难', diff: 2, drop: ['tm_w_base', 'set_weapon_base', '破军·锋', '破军·脊', 'pj_armor_base', '破军·铠', '破军·骨', 'pj_treasure_base', '破军·印', '破军·魄', 'ss_staff_base', 'ss_skull_base', 'ss_robe_base', '杖·降妖', '杖·沉', '串·髑', '串·咒', '袍·麻', '袍·禅'] },
  { type: 'elite', name: '黄风卷岭', diff: 3 },
  { type: 'mob',   name: '山神庙外·拦路小妖', diff: 4, gold: 30 },
  { type: 'event', name: '缘', diff: 5 },
  { type: 'trial', name: '劫难', diff: 6, drop: ['de_t_base', 'ts_robe_base', '袈裟·金线', '袈裟·佛纹'] },
  { type: 'shop',  name: '游方货郎', diff: 7, priceTier: 2 },
  { type: 'rest',  name: '土地庙', diff: 8 },  // 两界山段休整
  { type: 'trial', name: '劫难', diff: 9, drop: ['set_armor_base', '玄武·鳞', '玄武·心'] },  // 两界山收尾
  // 第10层起为「黄风岭三连难」复合节点（难10-13 合并，见 NDX.COMPOUND_NODES），由 generateMap 特殊生成
];
