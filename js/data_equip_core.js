...
//   数值 [已调优]（2026-09-14）：LUX_CHANCE 0.22→0.18。秘藏=必得金/红名器+1.6 倍金币的稀有奖励房，
//     原 22% 升格≈每 5 个宝窟出 1 个顶级房，过密会稀释「宝箱」惊喜感；降到 18%（≈1/5.5）维持可遇不可求的
//     奖励密度，又不低于 0.15 免后期长期缺席。门禁 _verify_treasure_lux 对概率参数化统计（rate≈chance±0.05/4000 样）。
NDX.TREASURE_LUX_CHANCE = 0.18;   // 宝窟 → 秘藏宝窟的升格概率（0.22→0.18，2026-09-14 已调优）
...
//   数值 [已调优]（2026-09-14）：low 不出红（red:0，门禁 _verify_fabao_tier B/D 锁死），high 抬金并小概率出红。
//     复核 low 金率 1/13≈7.7%、high 金率 6/11≈54.5%/红率 1/11≈9%，品阶阶梯「普通宝窟不顶格」清晰，确认保持原值。
NDX.FABAO_TIER_W = {
