...
,
  ...
  29: { id: 29, name: '三妖赌胜', act: 7, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '应赌破法，逐妖于求雨台前', fate: '战', fight: true, effect: {'alignEvil':8} },
      { key: '渡', label: '罢赌劝善，点三妖归正', fate: '渡', effect: {'alignGood':10} },
      { key: '隐', label: '避赌潜踪，暗查三清观底细', fate: '隐', effect: {'alignGood':4} },
    ],
    hidden: { hero: 'xiaobailong', cond: '战 + 战≥2', job: '夺宝龙子', desc: '龙的宝，迟早游回龙手里（白龙·夺宝龙子前置）' } },
  30: { id: 30, name: '车迟监·灭僧', act: 7, type: 'event', icon: '✦',
    ...
    options: [
      { key: '战', label: '劫牢破监，一战解僧厄', fate: '战', fight: true, effect: {'alignEvil':8} },
      { key: '渡', label: '入宫说法，谏王罢灭佛', fate: '渡', effect: {'alignGood':10} },
      { key: '隐', label: '避战暗访，密联城中僧众', fate: '隐', effect: {'alignGood':4} },
    ] },
