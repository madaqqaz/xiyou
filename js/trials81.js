...
NDX.TRIAL_LIB = {
  ...
  4: { id: 4, name: '寻亲报冤', act: 1, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '少年提剑，手刃刘洪', fate: '战', fight: true, battleFlags: { openingMomentum: 1 }, effect: { alignEvil: 6 }},
      { key: '渡', label: '放他入狱候审', fate: '渡', effect: {alignGood: 20} },
      { key: '逆', label: '逼问幕后', fate: '逆', effect: {alignEvil: 15} }
    ],
  ...
  5: { id: 5, name: '出城逢虎', act: 2, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '猎户助阵，双人杀虎', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
  ...
  7: { id: 7, name: '双叉岭上', act: 2, type: 'fight', icon: '◐',
    ...
    options: [
      { key: '战', label: '斩残魂开路', fate: '战', effect: { alignEvil: 8 }, fight: true, battleFlags: { openingMomentum: 1 }},
  ...
  8: { id: 8, name: '两界山头', act: 2, type: 'story', icon: '✦',
    ...
    options: [
      { key: '渡', label: '与他立约同行', fate: '渡', effect: { alignGood: 10, flag: '取经同行' } },
      { key: '逆', label: '以"保命"为条件', fate: '逆', effect: { alignEvil: 8, wukongMorale: true } },
  ...
  9: { id: 9, name: '两界山·鹰愁涧', act: 2, type: 'fight', icon: '🐉',
    ...
    options: [
      { key: '战', label: '降龙，强收为脚力', fate: '战', effect: { alignEvil: 6 }, fight: true, battleFlags: { openingMomentum: 1 }},
  ...
  10: { id: 10, name: '虎先锋前哨', act: 3, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '斗虎先锋，夺这半截经幡', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
  ...
  11: { id: 11, name: '黄风卷沙', act: 3, type: 'fight', icon: '🌪',
    ...
    options: [
      { key: '战', label: '踏风穿云，一拳定住风眼', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '请灵吉念一卷还香油经', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '趁风眼大开，夺它定风丹', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.58, duo: 'T0', treasure: 'tre_dingfengdan' , chain: 'hf_dan' },
  ...
  12: { id: 12, name: '三昧神风', act: 3, type: 'fight', icon: '🌀',
    ...
    options: [
      { key: '战', label: '请灵吉收风', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }, chainMul: ['hf_dan', 0.85] },
      { key: '渡', label: '借风势渡岭', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '逆风而上，夺它风袋', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.45, duo: 'T1', treasure: 'tre_fengdai' , chainMul: ['hf_dan', 0.85] },
  ...
  13: { id: 13, name: '黄风大圣', act: 3, type: 'fight', icon: '👑',
    ...
    options: [
      { key: '战', label: '决战黄风大圣', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }, chainMul: ['hf_dan', 0.78] },
      { key: '渡', label: '请灵吉菩萨收风', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '夺它那颗定风珠', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.48, duo: 'T1', treasure: 'tre_dingfengzhu' , chainMul: ['hf_ni', 1.12] },
  ...
  14: { id: 14, name: '流沙河畔·沙僧初遇', act: 4, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '战', label: '掷石入河，激妖出阵', fate: '战', effect: { alignEvil: 3 }, fight: true},
  ...
  15: { id: 15, name: '四圣试禅心', act: 4, type: 'event', icon: '✦',
    ...
    options: [
      { key: '渡', label: '合掌谢过，不入庄门', fate: '渡', effect: {'alignGood':10} },
      { key: '缘', label: '借宿一夜，点破机关', fate: '缘', effect: {'alignGood':6} },
      { key: '逆', label: '拂袖而去，讥其设局', fate: '逆', effect: {'alignEvil':8} },
    ] },
  16: { id: 16, name: '流沙九颅', act: 4, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '夺那骷髅串，与河底怨灵一战', fate: '战', effect: { alignEvil: 8 }, fight: true},
      { key: '渡', label: '合掌渡那九颅，送其转生', fate: '渡', effect: { alignGood: 10 } },
      { key: '隐', label: '绕开河底，避其锋芒', fate: '隐', effect: { alignEvil: 2 } },
  ...
  17: { id: 17, name: '河神问渡', act: 4, type: 'event', icon: '✦',
    ...
    options: [
      { key: '缘', label: '收下渡牌，记河神一恩', fate: '缘', effect: {'alignGood':6} },
      { key: '渡', label: '合掌应诺，代渡河魂', fate: '渡', effect: {'alignGood':10} },
      { key: '逆', label: '拒渡牌，只身涉水', fate: '逆', effect: {'alignEvil':8} },
      { key: '战', label: '夺那渡牌，自掌水路', fate: '战', effect: {'alignEvil':6} },
    ] },
  18: { id: 18, name: '流沙河收沙僧', act: 4, type: 'fight', icon: '⛓️',
    ...
    options: [
      { key: '战', label: '一战降之', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '木吒说降，归他一个正果', fate: '渡', effect: { alignGood: 15, ally: 'shaseng' } },
      { key: '夺', label: '夺他降妖宝杖', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.42, duo: 'T1', treasure: 'tre_baozhang' },
  ...
  19: { id: 19, name: '五庄观人参', act: 5, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '夺', label: '偷摘一枚人参果带在路上', fate: '夺', effect: { alignEvil: 8 } , fight: true, bossDiff: 1.6, duo: 'T0', treasure: 'tre_renshenguo' },
  ...
  20: { id: 20, name: '白骨三戏', act: 5, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '三打', fate: '战', fight: true, rounds: 3, battleFlags: { openingMomentum: 1 }, effect: { alignGood: 3 }},
      { key: '渡', label: '听她遗言', fate: '渡', effect: { alignGood: 15 } },
      { key: '逆', label: '撕了难簿这一页', fate: '逆', effect: {alignEvil: 10, treasure: 'ni_baigu' } }
,
      { key: '隐', label: '隐去真身，辨白骨三戏', fate: '隐', effect: {"alignGood":4} },
    ],
  ...
  21: { id: 21, name: '贬退心猿', act: 5, type: 'event', icon: '✦',
    ...
    intro: '叙事抉择（悟空离队）。',
    options: [
      { key: '渡', label: '忍痛放行', fate: '渡', effect: { alignGood: 10 } },
      { key: '逆', label: '悟空抗命不走', fate: '逆', effect: { alignEvil: 10, loosenCirclet: true } }
,
  ...
  23: { id: 23, name: '黑松林失', act: 6, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '召回悟空', fate: '战', fight: true, battleFlags: { openingMomentum: 1 }, effect: { alignGood: 8 }},
      { key: '隐', label: '智取', fate: '隐', effect: {alignGood: 4 } }
,
      { key: '夺', label: '夺回被掳行囊，趁乱而行', fate: '夺', effect: {"alignEvil":6} },
      { key: '渡', label: '求山神护佑，负伤而行', fate: '渡', effect: { alignGood: 10 } }
    ],
  ...
  24: { id: 24, name: '平顶山宝', act: 6, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '以假葫芦诓它，教它装了自己', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '上天请老君亲至，收二童归炉', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '夺紫金红葫芦与羊脂玉净瓶', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.6, duo: 'T0', treasure: 'tre_hulu' },
  ...
  25: { id: 25, name: '乌鸡井龙', act: 6, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '渡', label: '亲下井背尸', fate: '渡', effect: { alignGood: 10 } },
      { key: '缘', label: '八戒背尸', fate: '缘', effect: {alignGood: 6 } }
,
  ...
  26: { id: 26, name: '黑水鼍龙', act: 6, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '河神助战，擒那鼍龙', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '往西海请摩昂太子来收，归它一个龙族正籍', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '夺它颔下夜明珠', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.4, duo: 'T1', treasure: 'tre_yemingzhu' },
  ...
  27: { id: 27, name: '红孩真火', act: 6, type: 'fight', icon: '⚔',
    ...
    options: [
      ...
      { key: '夺', label: '夺它三昧真火', fate: '夺', effect: { alignEvil: 10 } , fight: true, bossDiff: 1.62, duo: 'T0', treasure: 'tre_sanmei' },
  ...
  30: { id: 30, name: '车迟监·灭僧', act: 7, type: 'event', icon: '✦',
    ...
    options: [
      { key: '战', label: '劫牢破监，一战解僧厄', fate: '战', fight: true, align: 'good', effect: {'alignGood':3} },
      { key: '渡', label: '入宫说法，谏王罢灭佛', fate: '渡', align: 'good', effect: {'alignGood':8} },
      { key: '隐', label: '避战暗访，密联城中僧众', fate: '隐', align: 'evil', effect: {'alignEvil':12} },
    ] },
  ...
  33: { id: 33, name: '灵感大王', act: 8, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '夺', label: '夺灵感庙金身，熔作路上盘缠', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.4, duo: 'T1', treasure: 'tre_jinshen' , chain: 'tt_jinshen' },
  ...
  34: { id: 34, name: '冰河渡难', act: 8, type: 'event', icon: '✦',
    ...
    options: [
      { key: '隐', label: '贴冰潜行，听它凿到天亮', fate: '隐', effect: { alignEvil: 2 } },
      { key: '渡', label: '诵经化冰，稳步过河', fate: '渡', effect: { alignGood: 10 } },
      { key: '战', label: '踏冰呐喊，引它破冰一战', fate: '战', fight: true, effect: { alignGood: 3 }, battleFlags: { openingMomentum: 1 }},
    ],
  ...
  35: { id: 35, name: '金兜金刚', act: 8, type: 'fight', icon: '⚔',
    ...
    options: [
      ...
      { key: '夺', label: '趁乱夺琢，金兜归你', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.65, duo: 'T0', treasure: 'tre_jingangzhuo' },
  ...
  36: { id: 36, name: '金鱼精·通天河决战', act: 8, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '翻江一战，擒那金鱼', fate: '战', fight: true, effect: { alignEvil: 3 }, battleFlags: { openingMomentum: 1 }, chainMul: ['tt_jinshen', 0.88] },
  ...
  37: { id: 37, name: '女儿国水', act: 9, type: 'event', icon: '✦',
    ...
    options: [
      { key: '战', label: '硬闯泉眼，强行夺水', fate: '战', effect: { alignEvil: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '与其论法，劝真仙放行', fate: '渡', effect: { alignGood: 10 } },
      { key: '缘', label: '取一葫芦子母河水——留着，说不定有用', fate: '缘', effect: { alignGood: 3 } },
  ...
  38: { id: 38, name: '落胎泉·解阳山', act: 9, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '夺泉一战，败如意真仙', fate: '战', effect: { alignEvil: 3 }, fight: true},
      { key: '渡', label: '以礼相求，请其解厄', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '夺他如意钩', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.42, duo: 'T1', treasure: 'tre_ruyigou' },
  ...
  39: { id: 39, name: '女王招亲', act: 9, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '隐', label: '夺通关文牒，连夜出城', fate: '隐', effect: { alignEvil: 6 } },
    ],
  ...
  40: { id: 40, name: '蝎精摄僧', act: 9, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '渡', label: '请昴日星官降之，以音破毒', fate: '渡', effect: { alignGood: 10 }, fight: true, bossDiff: 0.92},
      { key: '战', label: '以力破法，强战琵琶精', fate: '战', effect: { alignEvil: 8 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '夺', label: '夺她尾上那根倒马毒桩', fate: '夺', effect: { alignEvil: 8 } , fight: true, bossDiff: 1.62, duo: 'T0', treasure: 'tre_daomadu' },
      { key: '逆', label: '劝她弃邪西行——雷音寺推你那一把，我替你记着', fate: '逆', ni: true, effect: { alignEvil: 8, treasure: 'ni_xiejing' }, fight: true, battleFlags: { openingMomentum: 2, drainPct: 0.02 }, bossDiff: 1.18},
    ],
  ...
  41: { id: 41, name: '六耳初现', act: 10, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '战', label: '棒喝二猴，试其真身', fate: '战', effect: { alignEvil: 2 }, fight: true},
  ...
  45: { id: 45, name: '真假美猴王', act: 10, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '如来收六耳', fate: '战', effect: { alignGood: 2 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '与六耳和解', fate: '渡', effect: { alignGood: 15 } },
      { key: '夺', label: '夺他随心铁杆兵', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.48, duo: 'T1', treasure: 'tre_suixinbing' },
  ...
  46: { id: 46, name: '火焰借扇', act: 11, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '力夺真扇', fate: '战', effect: { alignEvil: 6 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '夺', label: '变虫入腹，逼她交扇', fate: '夺', effect: { alignEvil: 8 } , fight: true, bossDiff: 1.5, duo: 'T1', treasure: 'tre_bajiaoshan_ying' , chain: 'hy_jiashan' },
  ...
  48: { id: 48, name: '积雷山·牛魔王', act: 11, type: 'fight', icon: '⚔',
    ...
    intro: '火焰山——积雷山牛魔王挡道。',
    options: [
      { key: '战', label: '棒斗牛魔王，夺路入洞', fate: '战', effect: { alignEvil: 8 }, fight: true},
      { key: '渡', label: '攀交讲和，请他让扇', fate: '渡', effect: { alignGood: 10 } },
      { key: '隐', label: '夜袭摩云洞，盗那扇柄', fate: '隐', effect: { alignEvil: 6 } , chain: 'hy_bing' },
  ...
  49: { id: 49, name: '翠云山·真扇决战', act: 11, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '降伏牛魔，得真扇灭焰', fate: '战', effect: { alignGood: 3 }, fight: true, chainMul: ['hy_bing', 0.85] },
      { key: '渡', label: '以情动铁扇，化干戈为玉帛', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '巧夺芭蕉扇，拂焰而去', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.65, duo: 'T0', treasure: 'tre_bajiaoshan' , chainMul: ['hy_jiashan', 0.90] },
  ...
  50: { id: 50, name: '祭赛金光', act: 12, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '二郎助擒', fate: '战', fight: true, battleFlags: { openingMomentum: 1 }, effect: { alignGood: 6 }},
      { key: '渡', label: '夺回舍利超度', fate: '渡', effect: {alignGood: 12} , chain: 'js_du' }
,
      { key: '夺', label: '夺佛宝舍利，自取其一', fate: '夺', effect: {"alignEvil":6} , fight: true, bossDiff: 1.6, duo: 'T0', treasure: 'tre_sheli' , chain: 'js_sheli' },
    ],
  ...
  51: { id: 51, name: '金光寺冤僧', act: 12, type: 'event', icon: '✦',
    ...
    options: [
      { key: '渡', label: '为僧申冤', fate: '渡', effect: {alignGood: 10 } },
      { key: '逆', label: '趁乱夺塔中旧物', fate: '逆', effect: {alignEvil: 10} }
,
  ...
  52: { id: 52, name: '碧波潭探', act: 12, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '夺', label: '夺九叶灵芝草', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.42, duo: 'T1', treasure: 'tre_lingzhi' },
  ...
  53: { id: 53, name: '万圣盗草·乱石山伏', act: 12, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '战', label: '黑吃黑，夺下盗草赃物', fate: '战', effect: { alignEvil: 8 } },
  ...
  54: { id: 54, name: '九头虫·碧波潭', act: 12, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '战九头虫', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }, chainMul: ['js_sheli', 0.85] },
      { key: '渡', label: '请二郎显圣真君与梅山六兄弟来助', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '夺月牙铲，取回塔顶佛宝舍利', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.48, duo: 'T1', treasure: 'tre_yueyachan' , chainMul: ['js_sheli', 0.85] },
  ...
  55: { id: 55, name: '木仙谈诗', act: 13, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '夺', label: '夺其千年木心', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.42, duo: 'T1', treasure: 'tre_muxin' },
  ...
  56: { id: 56, name: '小雷音假佛', act: 13, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '渡', label: '请弥勒来收，归他一个座下', fate: '渡', effect: { alignGood: 12 }, fight: true, battleFlags: { dmgMul: 0.9, incomingDmgMul: 0.85 }},
      { key: '战', label: '一棒砸了这座假雷音', fate: '战', effect: { alignGood: 3 } },
      { key: '夺', label: '夺金铙法器，破其假阵', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.6, duo: 'T0', treasure: 'tre_jinnao' },
  ...
  57: { id: 57, name: '朱紫医王', act: 13, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '夺', label: '夺它三个金铃', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.58, duo: 'T0', treasure: 'tre_jinling' },
  ...
  58: { id: 58, name: '狮驼尸山·如来收鹏', act: 13, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '破尸山', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '超度亡魂', fate: '渡', effect: { alignGood: 20 } },
      { key: '夺', label: '夺阴阳二气瓶', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.62, duo: 'T0', treasure: 'tre_yinyangping' },
  ...
  59: { id: 59, name: '比丘白鹿', act: 14, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '隐', label: '隐于丹房，探白鹿底细', fate: '隐', effect: {alignGood: 2 } },
    ] },
  60: { id: 60, name: '灭法剃王', act: 14, type: 'event', icon: '✦',
    ...
    options: [
      { key: '缘', label: '化解', fate: '缘', effect: { gold: 30, alignGood: 8 } },
      { key: '逆', label: '剃尽僧发反制', fate: '逆', effect: { alignEvil: 8 } }
,
      { key: '夺', label: '夺其剃度刀，绝其王法', fate: '夺', effect: {"alignEvil":6} , fight: true, bossDiff: 1.4, duo: 'T1', treasure: 'tre_tidao' },
    ] },
  61: { id: 61, name: '隐雾梅花', act: 14, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '破它的分瓣梅花计', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
  ...
  62: { id: 62, name: '凤仙求雨', act: 14, type: 'event', icon: '✦',
    ...
    options: [
      { key: '渡', label: '建祠求雨', fate: '渡', effect: { alignGood: 15 }, disciple: 'fengxian' },
      { key: '逆', label: '咒天不下', fate: '逆', effect: {alignEvil: 10} }
,
  ...
  63: { id: 63, name: '玉华盗兵', act: 14, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '夺回三般兵器', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
  ...
  64: { id: 64, name: '竹节九狮', act: 15, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '硬接它这一衔，战到它松口', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
  ...
  65: { id: 65, name: '金平犀灯', act: 15, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '战到四木禽星下界', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '上奏天庭，请四木禽星收这三犀', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '夺犀角灯', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.4, duo: 'T1', treasure: 'tre_xijiaodeng' },
  ...
  66: { id: 66, name: '给孤招婚', act: 15, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '请太阴星君来收', fate: '战', effect: { alignGood: 3 }, fight: true, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '放她回月宫', fate: '渡', effect: { alignGood: 15 } },
      { key: '隐', label: '夺婚书聘礼，拂袖而去', fate: '隐', effect: { alignEvil: 6 } },
      { key: '逆', label: '不送她回月——她下界，只为报广寒宫那一记掌', fate: '逆', ni: true, effect: { alignEvil: 10 } },
    ],
    hidden: { hero: 'bajie', cond: '渡 + 日记装备≥2', job: '净坛·拾遗', desc: '渡了玉兔，行囊里多了几件奇物（八戒·净坛拾遗）', hint: '选「渡」放玉兔回月，并持有≥2件冒险日记奇物——你渡人，也拾奇' },
  },
  67: { id: 67, name: '铜台辨冤', act: 15, type: 'event', icon: '✦',
    ...
    options: [
      { key: '渡', label: '复活员外', fate: '渡', effect: { alignGood: 20 } },
      { key: '逆', label: '查真凶是官', fate: '逆', effect: {alignEvil: 8} }
,
  ...
  68: { id: 68, name: '玉兔假公主', act: 15, type: 'event', icon: '✦',
    ...
    options: [
      ...
      { key: '隐', label: '隐于月影，识破玉兔', fate: '隐', effect: {alignGood: 4 } },
    ] },
  ...
  70: { id: 70, name: '捣药杵', act: 15, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '夺', label: '夺那捣药杵，破其兵势', fate: '夺', effect: {'alignEvil':6} , fight: true, bossDiff: 1.42, duo: 'T1', treasure: 'tre_daoyaochu' , chain: 'tz_chu' },
      { key: '战', label: '迎战玉兔，直捣其巢', fate: '战', fight: true, effect: {'alignEvil':8}, battleFlags: { openingMomentum: 1 }},
      { key: '渡', label: '以佛法镇之，止其兵戈', fate: '渡', effect: {'alignGood':10} },
    ] },
  ...
  72: { id: 72, name: '玉兔精·天竺决战', act: 15, type: 'fight', icon: '⚔',
    ...
    options: [
      { key: '战', label: '一棒降玉兔，了结天竺之乱', fate: '战', effect: { alignEvil: 10 }, fight: true, chainMul: ['tz_chu', 0.85] },
      { key: '渡', label: '渡其归月，化干戈', fate: '渡', effect: { alignGood: 10 } },
      { key: '夺', label: '收其捣药杵为宝', fate: '夺', effect: { alignEvil: 6 } , fight: true, bossDiff: 1.45, duo: 'T1', treasure: 'tre_daoyaochu_yue' , chainMul: ['tz_chu', 0.80] },
  ...
  73: { id: 73, name: '化电归真', act: 16, type: 'story', icon: '☯',
    ...
    options: [
      { key: '渡', label: '受封', fate: '渡', effect: { alignGood: 10 } },
      { key: '逆', label: '拒封', fate: '逆', effect: { alignEvil: 20, flag: '逆道前置' } }
    ] },
  ...
  77: { id: 77, name: '灵山无字·大圣残躯', act: 16, type: 'boss', icon: '⚔',
    ...
    options: [
      { key: '渡', label: '归入经书', fate: '渡', effect: { alignGood: 10 }, ending: '真·结局（牺牲线）'},
      { key: '隐', label: '携碑遁走', fate: '隐', effect: { alignGood: 2 }, ending: '隐世结局（需全程隐≥阈值）'},
      { key: '战', label: '与这具大圣残躯打完最后一战', fate: '战', effect: { alignEvil: 8 } },
      { key: '逆', label: '碎无字碑', fate: '逆', ni: true, effect: { alignEvil: 15 }, ending: '逆道结局（反抗线，需全程逆≥阈值）', jobConfirm: '齐天·大圣'},
    ],
  ...
  80: { id: 80, name: '灵山索经·阿难迦叶', act: 17, type: 'boss', icon: '⚰️',
    ...
    options: [
      { key: '战', label: '砸了白纸经，索还人事', fate: '战', fight: true, battleFlags: { openingMomentum: 1 }, effect: { alignEvil: 6 } },
      { key: '渡', label: '以紫金钵相赠，求有字真经', fate: '渡', effect: { alignGood: 12 } },
      { key: '逆', label: '夺回紫金钵，讥其二尊者贪墨', fate: '逆', ni: true, effect: { alignEvil: 10 } },
    ],
  ...
  81: { id: 81, name: '通天河遇鼋湿经', act: 17, type: 'boss', icon: '⚰️',
    ...
    options: [
      ...
      { key: '渡', label: '如实相告 · 引渡老鼋', fate: '渡', ending: '善之结局', effect: { alignGood: 15 }},
      { key: '隐', label: '携湿经隐世', fate: '隐', ending: '隐世结局（全员隐藏职激活）', effect: { alignEvil: 6 }}
    ],
